"""
Django settings for monoapplication project.
...
SECRET_KEY = 'django-insecure-45_qif9bjnq223p3yyn@9@3a5fym+42#^oc(+6*33+v+4zdn_o'
...
ROOT_URLCONF = 'monoapplication.urls'
...
WSGI_APPLICATION = 'monoapplication.wsgi.application'
